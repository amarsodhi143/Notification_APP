...
{
    public class Notification_Delayed_Fragment : BaseFragment
    {
        public Notification_Delayed_Fragment(AppCompatActivity context) : base(context)
        {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return inflater.Inflate(Resource.Layout.notification_delayed_fragment, null);
        }

        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            var data = new SqlHelper().GetAllData<NotificationLog>();
